      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            CONTEST <span className="text-blue-600">GUIDELINES</span>
          </h2>
        </div>

        {/* About the Competition */}
        <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg mb-8">
          <h3 className="text-2xl font-bold text-blue-600 mb-6">About the Competition:</h3>
          <ol className="space-y-4 text-gray-700 text-lg">
            <li className="flex items-start space-x-3">
              <span className="text-blue-600 font-bold min-w-6">1.</span>
            ...
            <li className="flex items-start space-x-3">
              <span className="text-blue-600 font-bold min-w-6">8.</span>
            ...
            <li className="flex items-start space-x-3">
              <span className="text-blue-600 font-bold min-w-6">12.</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <h4 className="text-xl font-bold text-blue-600 mb-3">Admission Rights:</h4>
              <p className="text-gray-700">YSM Info Solution reserves all admission rights.</p>
            </div>

            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <h4 className="text-xl font-bold text-blue-600 mb-3">Qualification for Prizes:</h4>
              <p className="text-gray-700">Minimum 50 marks are required to pass.</p>
            </div>

            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <h4 className="text-xl font-bold text-blue-600 mb-3">Payment and Refund:</h4>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <h4 className="text-xl font-bold text-blue-600 mb-3">Invoice and Receipts:</h4>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <h4 className="text-xl font-bold text-blue-600 mb-3">Competition Updates:</h4>
              <p className="text-gray-700">Participants will receive all updates on their registered email ID or whatsapp number.</p>
            </div>

            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-lg">
              <h4 className="text-xl font-bold text-blue-600 mb-3">Rewards and Recognition:</h4>
