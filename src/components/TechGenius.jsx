                ...
                <>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button
                      ...
                      className="bg-gradient-to-r from-white to-purple-50 bg-opacity-95 hover:bg-opacity-100 rounded-full p-6 transition-all duration-300 transform hover:scale-110 shadow-2xl border-2 border-purple-200"
                    >
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-gradient-to-r from-white to-purple-50 bg-opacity-30 backdrop-blur-sm rounded-lg p-4 border border-white border-opacity-30">
